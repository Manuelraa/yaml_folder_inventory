...
## Difference between expected.json and old-expected.json and 28-expected.json
...
ansible 2.8 however still had the empty dict in the hostvars even when it's empty
